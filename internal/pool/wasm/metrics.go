...
var (
	metricHit       = expvar.NewInt("aerolvm_wasm_pool_hits_total")
	metricMiss      = expvar.NewInt("aerolvm_wasm_pool_misses_total")
	metricRefill    = expvar.NewInt("aerolvm_wasm_pool_refills_total")
	metricSpawnFail = expvar.NewInt("aerolvm_wasm_pool_spawn_fails_total")
)
