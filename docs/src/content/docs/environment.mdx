...
Any OCI-compatible image reachable by the Docker daemon on the host. Public images are pulled automatically. Private registries require the host Docker daemon to be pre-authenticated.
