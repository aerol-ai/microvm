...
|---|---|---|
| [Coding Agents & Autonomous Engineering](/use-cases/coding-agents/) | It is the highest-priority category in the plan and maps directly to AerolVM's strongest primitives: streamed execution, files, sessions, and isolation. | Autonomous issue-to-PR agent, PR review and auto-fix agent, test-writing and failure reproduction agent, dependency upgrade agent, large-scale refactor or migration agent |
