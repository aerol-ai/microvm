# cluster-hetero-secrets — plans/integration-test-security.md §6.2.
# Flagship. Role-separated failover, reseal on drain/add, audit fan-out across a real ingress tier, storage retirement, fleet-scale read paths.
#
...
# profile is overlaid.
cluster_name = "aerolvm-itest-cluster-hetero-secrets"
