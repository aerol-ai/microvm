...
// runtime), cluster-3-mixed-fc (docker + firecracker), and cluster-3-mixed-wasm
// (docker + wasm) — because they are slow and provision
...
// scenarios (cluster-hetero, cluster-3-mixed-fc, cluster-3-mixed-wasm), but the benchmark is slow and the density probe provisions sandboxes until
